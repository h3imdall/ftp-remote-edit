...
export default class ConfigurationView extends View {
  ...
  createControls() {
    ...
    let folderSelectContainer = document.createElement('div');
    folderSelectContainer.classList.add('select-container');
    folderSelectContainer.appendChild(self.folderSelect);
    self.folderEdit = document.createElement('button');
    self.folderEdit.textContent = 'Edit';
    self.folderEdit.classList.add('btn');
    self.folderEdit.classList.add('pull-right');
    folderSelectContainer.appendChild(self.folderEdit);
    ...
    folderControl.appendChild(folderSelectContainer);
    ...
    serverGroup.appendChild(folderControl);
  ...
  fillInputFields(server = null) {
    ...
    if (server) {
      ...
      if(Storage.getFolder(server.parent)) {
          self.folderSelect.selectedIndex = Storage.getFolder(server.parent).id;
      } else {
          self.folderSelect.selectedIndex = 'null';
      }
  ...
  editFolders() {
    ...
    if(index > 0) {
        ...
        folderConfigurationView.disableInputFields();
    }
