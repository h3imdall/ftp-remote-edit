...
class DirectoryView extends View {
  ...
  move(initialPath, newDirectoryPath) {
    console.log('move', initialPath, newDirectoryPath);
  }
  ...
  onDrop(e) {
    ...
    if (entry = e.target.closest('.entry')) {
      ...
      newDirectoryPath = self.getPath(true);
      if (!newDirectoryPath) {
        return false;
      }
      ...
      if (initialPath) {
        ...
        self.move(initialPath, newDirectoryPath);
      } else {
        // Drop event from OS
        if (e.dataTransfer) {
