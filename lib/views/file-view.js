...
class FileView extends View {
  ...
  rename(relativePath) {
    ...
    self.getRoot()
      ...
      .then(() => {
        self.getRoot().getFinderItemsCache().renameItem(self.getPath(false) + self.name, relativePath, self.size);
  ...
  delete() {
    ...
    self.getRoot()
      ...
      .then(() => {
        self.getRoot().getFinderItemsCache().deleteItem(self.getPath(false) + self.name);
        self.destroy();
      })
      .catch(function (err) {
        self.getRoot()
