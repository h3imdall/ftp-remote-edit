...
class FileView extends View {
  ...
  open() {
    ...
    self.getRoot().connector.existsFile(self.getPath(true) + self.name)
      .then((file) => {
        if (file !== undefined && file !== null) {
          ...
          self.getRoot().connector.downloadFile(self.getPath(true) + self.name, self.getLocalPath(true) + self.name)
            .then(() => {
            ...
            .then((editor) => {
              if (self.editor === null || self.editor === undefined) {
                ...
                editor.onDidSave((saveObject) => {
                  self.getRoot().connector.uploadFile(editor.getText(), self.getPath(true) + self.name, editor.getPath(true))
                    .then(() => {
