...
class FileView extends View {
  ...
  addSyncFileIcon(element = null) {
    ...
    element.label.addClass('icon-sync')
      .addClass('spin')
  ...
  removeSyncFileIcon(element = null) {
    ...
    element.label.removeClass('icon-sync')
      .removeClass('spin')
  ...
  rename(relativePath) {
    ...
    self.getRoot()
      ...
      .then(() => {
        self.updateFinderItemsCache(relativePath, self.size, ADD_CACHE);
        self.updateFinderItemsCache(self.getPath(false) + self.name, self.size, DELETE_CACHE);
  ...
  copyDirectory(initialPath, newDirectoryPath) {
    ...
    self.parent.copyDirectory(initialPath, newDirectoryPath);
  }
