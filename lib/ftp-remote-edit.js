...
class FtpRemoteEdit {
  ...
  copy() {
    ...
    window.localStorage.removeItem('ftp-remote-edit:cutPath')
    window.localStorage['ftp-remote-edit:copyPath'] = JSON.stringify(storage)
  }
  ...
  cut() {
    ...
    let element = selected.view();
    let storage = element.serialize();
    window.localStorage.removeItem('ftp-remote-edit:copyPath')
    window.localStorage['ftp-remote-edit:cutPath'] = JSON.stringify(storage)
  }
  ...
  paste() {
    ...
    if (window.localStorage['ftp-remote-edit:cutPath']) {
      cutObject = JSON.parse(window.localStorage['ftp-remote-edit:cutPath']);
    }

    if (window.localStorage['ftp-remote-edit:copyPath']) {
      copiedObject = JSON.parse(window.localStorage['ftp-remote-edit:copyPath']);
    }
