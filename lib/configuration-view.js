...
export default class ConfigurationView {
  ...
  constructor(password) {
    ...
    label.textContent = 'The connection information is an array with connection objects. For security connections click the link to learn more about the propertys for the connection object. Look at the "connect" method. ';
