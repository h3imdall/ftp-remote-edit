...
class Import {
  ...
  import(_callback) {
    ...
    Electron.remote.dialog.showOpenDialog(null, { title: 'Select file to import', defaultPath: Electron.remote.app.getPath("desktop"), buttonLabel: 'Import', filters: [{ name: 'All Files', extensions: ['*'] }, { name: 'remote-ftp config file', extensions: ['ftpconfig'] }, { name: 'FileZilla site export file', extensions: ['xml'] }, { name: 'PHP Storm export file', extensions: ['xml'] }], properties: ['openFile', 'showHiddenFiles'] }, (filePaths, bookmarks) => {
      if (filePaths) {
            ...
            FileSystem.readFile(filePath, function (e, data) {
              ...
              try {
                ...
                if (typeof json['FileZilla3'] !== 'undefined') {
                  ...
                  imported = self.importPHPStorm(json['application']['component']['option']['webServer'], null);
                  self.importSuccess(imported);
                  if (_callback instanceof Function)
                    _callback();
                }
